    ...
    <div className="bg-gray-50 h-screen w-screen flex flex-col">
          ...
          <div className="grid grid-cols-1 gap-y-4 lg:items-center lg:grid-cols-2 xl:grid-cols-2">
            <div className="text-center xl:col-span-1 lg:text-left md:px-16 lg:px-0 xl:pr-20">
              <h1 className="text-2xl font-bold leading-tight text-gray-900 sm:text-2xl sm:leading-tight lg:text-3xl lg:leading-tight font-pj">
                An online IDE that lets you code, collaborate and deploy
                software projects in your browser, all without any setup.
              </h1>
              <p className="mt-2 text-lg text-gray-600 sm:mt-6 font-inter">
                Allows users to write, run, and share code directly from their
                browser, offering features such as real-time collaboration, and
                an integrated development experience without the need for local
                setup.
              </p>
              ...
              <div className="flex flex-row mt-4 space-x-4 justify-center lg:justify-start">
                <div className="card" onClick={handleCardClick}>
                  <h2
                    className="inline-flex px-8 py-2 mt-4 text-lg font-bold text-white transition-all duration-200 bg-gray-900 border border-transparent rounded sm:mt-4 font-pj hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900
                                        font-mono"
                    role="button"
                  >
                    Create Repl
              ...
              <div className="mt-8 sm:mt-8">
                ...
                <blockquote className="mt-6">
                  ...
                  <p className="mt-3 text-base leading-7 text-gray-600 font-inter">
                    It has many features and is easy to use, and has a clean
                    interface so that everyone can code easily. This platform's
                    main advantage is that it can code in several languages and
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-10">
          <div
            className="modal bg-white border border-gray-300 p-4 w-100
                        rounded-md text-center "
          >
            <h2 className="text-[30px] m-4 font-bold mb-4 font-mono">
              Choose Environment
            </h2>
            <input
              type="text"
            ...
            <button
              ...
              className="bg-gray-900 text-white hover:bg-black border border-gray-900 font-bold py-2 px-4 rounded mt-2 mb-4 font-mono w-[90%] text-[25px]"
            >
              Create Repl
            </button>
            <button
            ...
            <button
              ...
              className="bg-gray-300 text-black hover:bg-gray-400 border border-gray-300 font-bold py-2 px-4 rounded mt-2 mb-10 font-mono w-[90%] text-[25px]"
            >
              Close
            </button>
          </div>
      ...
      {showImportModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-10">
          <div className="modal bg-white border border-gray-300 p-8 w-100 rounded-md text-center">
            <h2 className="text-[30px] m-2 -mt-2  mb-6 font-mono font-semibold">
              Import from GitHub
            </h2>
            <input
              type="text"
            ...
            />
            <button
              onClick={() => handleImportFromGitHub("empty")}
              className="bg-gray-900 text-white hover:bg-black border border-gray-900 font-bold py-2 px-4 rounded mt-4 font-mono w-full text-[20px] mb-2 "
            >
              Import
            </button>
            <button
              onClick={() => setShowImportModal(false)}
              className="bg-gray-300 text-black hover:bg-gray-400 border border-gray-300 font-bold py-2 px-4 rounded mt-2 font-mono w-full text-[20px] mb-2"
            >
              Cancel
            </button>
          </div>
